...
function App() {
  ...
  const { runTransaction } = window.firebase;
  ...
  useEffect(() => {
    if (dbRead && dbWrite) {
      ...
      // !! ថ្មី !!: 7. ទាញ Pass Prefix
      const prefixRef = ref(dbWrite, 'passManagement/passPrefix');
      ...
      // !! ថ្មី !!: 8. ទាញ Pass Start Number
      const startNumRef = ref(dbWrite, 'passManagement/passStartNumber');
  ...
  }, [handleOpenPasswordModal, tRef, passPrefix, dbWrite, ref, set, showAlert]);
  ...
  }, [handleOpenPasswordModal, tRef, passStartNumber, dbWrite, ref, set, showAlert]);
